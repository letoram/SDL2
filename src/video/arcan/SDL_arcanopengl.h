...
#define ARCAN_GL_DeleteContext   SDL_EGL_DeleteContext
#define ARCAN_GL_GetSwapInterval SDL_EGL_GetSwapInterval
#define ARCAN_GL_SetSwapInterval SDL_EGL_SetSwapInterval
